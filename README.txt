...
- Product Catalog**: Display products fetched from the external API
...
1. Browse Products:
   ...
   - Use category filter to narrow down the selection
...
3. Manage Cart:
   - Click "Cart" in the navigation to view items
...
- ✅ Bootstra: Component usage, responsive utilities
